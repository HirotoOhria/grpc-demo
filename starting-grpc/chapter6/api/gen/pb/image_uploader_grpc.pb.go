...
// All implementations should embed UnimplementedImageUploadServiceServer
// for forward compatibility
type ImageUploadServiceServer interface {
	Upload(ImageUploadService_UploadServer) error
}

// UnimplementedImageUploadServiceServer should be embedded to have forward compatible implementations.
